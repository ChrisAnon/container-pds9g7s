...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pds9g7s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pds9g7s.containers.anotherwebservice.com/
...
```
git clone git@github.com:ChrisAnon/container-pds9g7s.git
cd container-pds9g7s
```
...
```
docker attach container-pds9g7s
```
